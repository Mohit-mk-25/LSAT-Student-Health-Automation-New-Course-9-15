...
FROM lsat_enr
 ...
 join jasperhistories.sequencescores ss
      on actf.activity_id = ss.sequenceid
      and actf.history_db_id = ss.historydbid
where 
  actf.history_db_id = '17' 
  and ss.name in ('scaledScore')
